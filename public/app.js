...
function initRussianLocale() {
  const textMap = new Map([
    ...
    ["Regular Shop", "Обычный магазин"],
    ["Standard skins for points.", "Обычные скины за очки."],
    ["Exclusive Crystal Shop", "Эксклюзивный магазин кристаллов"],
    ["Exclusive skins available only for crystals.", "Эксклюзивные скины только за кристаллы."],
    ["Inventory", "Инвентарь"],
